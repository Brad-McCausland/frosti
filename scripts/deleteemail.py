...
def main():
	...
	#read file
	emailFile = open(os.path.join(os.path.expanduser('~'),"frosti/alertSrc/user_register/email.txt"), 'r')
	lines = emailFile.readlines()
	emailFile.close()

	#open file for overwriting
	emailFile = open(os.path.join(os.path.expanduser('~'),"frosti/alertSrc/user_register/email.txt"), 'w')
