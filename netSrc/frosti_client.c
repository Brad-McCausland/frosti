...
main( int argc, char **argv) {
	...
	if (connect(sd, (struct sockaddr *)&sad, sizeof(sad)) < 0){ 
		...
		system("python /home/pi/frosti/alertSrc/hardwareAlert.py 'Alert: Frosti is not responding to redundancy checks and appears to be powered down.'");
  ...
  if(diff > 15){
    system("python /home/pi/frosti/alertSrc/hardwareAlert.py 'Alert: Frosti is active but is not recording temperatures.'");
